...
export const tz_groups = tzdata.map(t => {return t.group})
export const get_tzs_by_group = (group) => {
    let grouplist = tzdata.filter(t => {return t.group === group});
    if (grouplist.length > 0) {
        return grouplist[0].zones;
    } else {
        return [];
    }
